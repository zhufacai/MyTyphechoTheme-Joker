  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
          <li><a href="https://www.joker.cc/category/note">首页</a></li>
          <li><?php $this->widget('Widget_Metas_Category_List')->to($categorys); ?>
...
<!--/.文章页面-->
  ...
  <div class="col-xs-12">
     ...
     <div class="list-group">
     	<?php while($this->next()): ?>
		<a  class="list-group-item"><b><span class="badge"><?php $this->category(',', false); ?></span>  <?php $this->date('Y年m月d日'); ?> / <?php $this->title(1000) ?></b>
		</a>
		<?php endwhile; ?>
