...
<head>
	...
	<!-- 百度统计 -->
	<script> var _hmt = _hmt || []; (function() {   var hm = document.createElement("script");   hm.src = "https://hm.baidu.com/hm.js?5af74b8d5d1b5ae81fce341d7d66a638";   var s = document.getElementsByTagName("script")[0];    s.parentNode.insertBefore(hm, s); })(); </script>
</head>
...
<body class="is-preload">
	...
	<div id="wrapper">
		<!-- Header -->
		<header id="header">
			<h1><a href="<?php $this->permalink() ?>"><strong><?php $this->title() ?></strong> Powered by JOKER</a></h1>
			<nav>
				<ul>
			...
			<div class="inner split">
				<div>
					...
					<p class="copyright">
						...
						&copy; 2022 <a href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title() ?></a> Based HTML5UP.
					</p>
				</div>
				<div>
					<section>
